...
class TestView(TestCase):
    ...
    def test_create_post(self):
        ...
        self.client.post('/blog/create_post/', {'title' : 'Post Form 만들기', 'content' : "Post Form 페이지를 만듭시다.",})
    ...
    def test_update_post(self):
        ...
        response = self.client.post(update_post_url, { 'title' : '세 번째 포스트를 수정했습니다. ', 'content': '안녕 세계 우리는 하나!', 'category':self.category_music.pk},follow=True)
